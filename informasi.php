...
<body>
    <nav>
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="informasi.php" class="active">Informasi</a></li>
    ...
    <div class="hero">
        <h1>Informasi Penyakit Neurologi</h1>
    ...
    <section id="informasi">
        ...
        <div id="card-list" class="examples-grid">
            <div class="example-card">
                ...
                <img src="images/stroke.jpg" alt="Ilustrasi Stroke" class="card-image">
            ...
            <div class="example-card">
                ...
                <img src="images/kejang.jpeg" alt="Ilustrasi Epilepsi" class="card-image">
                <div class="example-body">
            ...
            <div class="example-card">
                ...
                <img src="images/meningtis.jpg" alt="Ilustrasi Meningitis" class="card-image">
                <div class="example-body">
            ...
            <div class="example-card">
                ...
                <img src="images/alzheimer.jpg" alt="Ilustrasi Alzheimer" class="card-image">
                <div class="example-body">
            ...
            <div class="example-card">
                ...
                <img src="images/parkinson.jpg" alt="Ilustrasi Parkinson" class="card-image">
                <div class="example-body">
            ...
            <div class="example-card">
                ...
                <img src="images/neuropati.jpg" alt="Ilustrasi Neuropati" class="card-image">
                <div class="example-body">
